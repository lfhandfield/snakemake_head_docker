...
RUN apt-get update 
RUN apt-get -y install build-essential vim man tk libc6-dbg gdb valgrind libfreetype6-dev
...
RUN /singularity/configure --prefix=/opt/singularity ; make -C /singularity/ ; sudo make -C /singularity/ install
CMD ["snakemake"]
